...
package com.flengine.components.renderables.jointanim
{
    ...
    public class JAnim extends FRenderable 
    {
        ...
        public function Draw(p_context:FContext):void
        {
            if (!SetupSpriteInst())
            {
                return;
        ...
        private function DrawSprite(p_context:FContext, theSpriteInst:JASpriteInst, theTransform:JATransform, theColor:JAColor, additive:Boolean, parentFrozen:Boolean):void
        {
            var _local7 = null;
            var _local16:int;
            var _local20 = null;
            ...
            var _local14:Number;
            var _local18:int;
            var _local17:JAFrame = theSpriteInst.spriteDef.frames[theSpriteInst.frameNum];
                ...
                if (_local8.alpha != 0)
                {
                    ...
                    else
                    {
                        ...
                        while (true)
                        {
                            ...
                            {
                                p_context.draw3(_local21.texture, _helpDrawSprite, (_local8.red * 0.003921568627451), (_local8.green * 0.003921568627451), (_local8.blue * 0.003921568627451), (_local8.alpha * 0.003921568627451), ((((additive) || (_local20.isAdditive))) ? 2 : 1));
                            }
                            else
                            {
                                if (_listener != null)
        ...
        private function PrepSpriteInstFrame(theSpriteInst:JASpriteInst, theObjectPos:JAObjectPos):void
        {
            ...
            var _local4:int;
            var _local3:int;
            var _local9:JAFrame = theSpriteInst.spriteDef.frames[theSpriteInst.frameNum];
            ...
            while (_local11 < theFrame.commandVector.length)
            {
                ...
                if ((((_listener == null)) || (!(_listener.JAnimCommand(_id, this, theSpriteInst, _local10.command, _local10.param)))))
                {
                    if (_local10.command == "delay")
                    {
                        ...
                        if (_local6 != -1)
                        {
                            _local16 = _local10.param.substr(0, _local6);
                            _local20 = _local10.param.substr((_local6 + 1));
                        ...
                        if (_local10.command == "playsample")
                        {
                            ...
                            while (_local19.length > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        _local12 = _local4.substr(7);
                                    }
                                    else
                                    {
                                        if (_local4.substr(0, 4) == "pan=")
                                        {
                                            _local5 = _local4.substr(4);
                                        }
                                        else
                                        {
                                            if (_local4.substr(0, 6) == "steps=")
                                            {
                                                _local15 = _local4.substr(6);
                                            };
                                        };
                                    };
                                };
        ...
        private function CalcObjectPos(theSpriteInst:JASpriteInst, theObjectPosIdx:int, frozen:Boolean):void
        {
            ...
            var _local11:JAFrame = theSpriteInst.spriteDef.frames[theSpriteInst.frameNum];
