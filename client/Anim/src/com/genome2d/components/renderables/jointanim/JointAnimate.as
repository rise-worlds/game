...
package com.genome2d.components.renderables.jointanim
{
    ...
    public class JointAnimate 
    {
        ...
        public function LoadPam(steam:ByteArray, texture:GTextureAtlas):int
        {
            ...
            while (_local13 < _local9)
            {
                ...
                if (((((!((_local12 == -1))) && (!((_local10 == -1))))) && ((_local12 < _local10))))
                {
                    ...
                    if (_local5 != -1)
                    {
                        _local6.cols = parseInt(_local17.substr(0, _local5));
                        _local6.rows = parseInt(_local17.substr((_local5 + 1)));
                    };
                };
        ...
        private function Load_GetImage(p_theImage:JAImage, p_texture:GTextureAtlas):Boolean
        {
        ...
        private function LoadSpriteDef(steam:ByteArray, jaSpriteDef:JASpriteDef):Boolean
        {
            ...
            while (_local22 < _local5)
            {
                ...
                if ((_local4 & FRAMEFLAGS_HAS_REMOVES))
                {
                ...
                if ((_local4 & 4))
                {
                    ...
                    while (_local19 < _local13)
                    {
                        ...
                        if ((_local7 & MOVEFLAGS_HAS_MATRIX))
                        {
                        ...
                        {
                            if ((_local7 & MOVEFLAGS_HAS_ROTATE))
                            {
                        ...
                        if ((_local7 & MOVEFLAGS_HAS_LONGCOORDS))
                        {
                        ...
                        _local25.hasSrcRect = !(((_local7 & MOVEFLAGS_HAS_SRCRECT) == 0));
                        if ((_local7 & MOVEFLAGS_HAS_SRCRECT))
                        {
                        ...
                        if ((_local7 & MOVEFLAGS_HAS_COLOR))
                        {
                        ...
                        if ((_local7 & MOVEFLAGS_HAS_ANIMFRAMENUM))
                        {
		...
		private const PAM_MAGIC:uint = 3136297300;
		private const PAM_VERSION:uint = 5;
		private const FRAMEFLAGS_HAS_REMOVES:uint = 1;
		private const FRAMEFLAGS_HAS_ADDS:uint = 2;
		private const FRAMEFLAGS_HAS_MOVES:uint = 4;
		private const FRAMEFLAGS_HAS_FRAME_NAME:uint = 8;
		private const FRAMEFLAGS_HAS_STOP:uint = 16;
		private const FRAMEFLAGS_HAS_COMMANDS:uint = 32;
		private const MOVEFLAGS_HAS_SRCRECT:uint = 0x8000;
		private const MOVEFLAGS_HAS_ROTATE:uint = 0x4000;
		private const MOVEFLAGS_HAS_COLOR:uint = 0x2000;
		private const MOVEFLAGS_HAS_MATRIX:uint = 0x1000;
		private const MOVEFLAGS_HAS_LONGCOORDS:uint = 0x0800;
