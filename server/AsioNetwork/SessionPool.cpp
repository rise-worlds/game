...
SessionPool::SessionPool(boost::asio::io_service& ioservice, unsigned int nSize, unsigned int nSendBufferSize, unsigned int nRecvBufferSize,
...
void SessionPool::Create(boost::asio::io_service& ioservice, unsigned int nSize, unsigned int nSendBufferSize, unsigned int nRecvBufferSize,
                         unsigned int nMaxPacketSize, unsigned int nTimeOutTick, unsigned int nIndexStart, bool bAcceptSocket)
{
    ENTER_FUNCTION_FOXNET
    m_nMaxSize = nSize;
